...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BB4PMdZc.js");
...
const manifest = {
  "99fe2fc4ddf470671de046fee43bdd77e5b2556cb4a35890063ebbe2d3f19703": {
    functionName: "analyzeProductImage_createServerFn_handler",
    importer: () => import("./adminAnalyze.functions-BEpTQ6Hq.js")
  },
  "b8c6ee5cd835032fe39f1196ebb398701c7cffa33d6f448016e6c7e0f95deec3": {
    functionName: "chatWithFlorist_createServerFn_handler",
    importer: () => import("./chat.functions-J7t20j8h.js")
  },
  "deaaf386aabfab3b872266bf1935e099a77a5e41532c5d6561e4b0e73d639b04": {
    functionName: "checkAdminPassword_createServerFn_handler",
    importer: () => import("./adminAnalyze.functions-BEpTQ6Hq.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DQf0jzPI.js").then((n) => n.r),
