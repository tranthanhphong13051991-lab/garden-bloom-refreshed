...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Bloom Better is a modern e-commerce platform for selling flowers and related products." },
      { property: "og:description", content: "Bloom Better is a modern e-commerce platform for selling flowers and related products." },
      { name: "twitter:description", content: "Bloom Better is a modern e-commerce platform for selling flowers and related products." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/64702fc3-a8ee-49dc-8825-f329d0973847/id-preview-5910a474--01295773-b408-40bc-9ff7-fb98f50cca33.lovable.app-1777401061037.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/64702fc3-a8ee-49dc-8825-f329d0973847/id-preview-5910a474--01295773-b408-40bc-9ff7-fb98f50cca33.lovable.app-1777401061037.png" },
    ],
    links: [
